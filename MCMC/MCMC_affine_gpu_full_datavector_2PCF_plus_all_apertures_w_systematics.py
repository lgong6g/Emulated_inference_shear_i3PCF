...
data_vec_2PCF = np.load("../data/testing_grids/updated_testing/DES_Y3/DES_Y3_2PCF.npy")
data_vec_i3PCF = np.load("../data/testing_grids/updated_testing/DES_Y3/DES_Y3_3PCF.npy")
...
np.save('MCMC_all_data_vector_DESY3_'+str(ndim)+'dim_model_1e3steps_alphaIA_0_w_nside512_updated_H_chi_D_david_cov',samples)
