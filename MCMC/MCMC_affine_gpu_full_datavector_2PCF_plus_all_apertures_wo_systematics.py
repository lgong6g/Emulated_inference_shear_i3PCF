...
covariance = np.load('../data/testing_grids/updated_testing/cov/cov_2+i3PCF.npy')
...
data_vec_i3PCF = np.load("../data/testing_grids/updated_testing/cosmogridv1_fiducial_all_i3PCF_data_vector.npy")
data_vec = np.concatenate((data_vec_2PCF, data_vec_i3PCF))
#data_vec = data_vec_U90W90[:90]
data_vec = tf.convert_to_tensor(data_vec, dtype=tf.float32)
...
emulator_H = tf.saved_model.load('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e3_inducing_variable_sgpr_H_3e4_nodes_standardscale/')
emulator_chi = tf.saved_model.load('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e3_inducing_variable_sgpr_chi_3e4_nodes_standardscale/')
emulator_D = tf.saved_model.load('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e3_inducing_variable_sgpr_D_3e4_nodes_standardscale/')

H_mean = np.loadtxt('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e4_nodes_H_mean.dat')
H_std = np.loadtxt('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e4_nodes_H_std.dat')
chi_mean = np.loadtxt('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e4_nodes_chi_mean.dat')
chi_std = np.loadtxt('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e4_nodes_chi_std.dat')
D_mean = np.loadtxt('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e4_nodes_D_mean.dat')
D_std = np.loadtxt('/home/ubuntu/reconstructed_kappa_pdf/data/trained_models/H_chi_D_models/gp_model_3e4_nodes_D_std.dat')
...
n_zs_los_BIN1 = tf.convert_to_tensor(n_s_z_BIN1(z_list_integ), dtype=tf.float32)
n_zs_los_BIN2 = tf.convert_to_tensor(n_s_z_BIN2(z_list_integ), dtype=tf.float32)
n_zs_los_BIN3 = tf.convert_to_tensor(n_s_z_BIN3(z_list_integ), dtype=tf.float32)
n_zs_los_BIN4 = tf.convert_to_tensor(n_s_z_BIN4(z_list_integ), dtype=tf.float32)
...
def start_position_lh_and_step_size(seed):
    ...
    for i in range(nwalkers):
        ...
        p0.append([Om_rand, As_rand, w0_rand, h_rand, cmin_rand])
...
def from_parameters_tensor_to_table(theta_tensor):
    ...
    training_parameters_names = ['Omega_m', 'As', 'w0', 'h', 'c_min']
...
def get_H_chi_q_from_GP(theta):
    ...
    n_zs_los_BIN1_prime = tf.repeat(tf.reshape(n_zs_los_BIN1, [1, -1]), theta.shape[0], axis=0)
    n_zs_los_BIN1_prime = tf.repeat(tf.reshape(n_zs_los_BIN1_prime, [theta.shape[0], -1, n_z_los]), n_z_los, axis=1)
    n_zs_los_BIN2_prime = tf.repeat(tf.reshape(n_zs_los_BIN2, [1, -1]), theta.shape[0], axis=0)
    n_zs_los_BIN2_prime = tf.repeat(tf.reshape(n_zs_los_BIN2_prime, [theta.shape[0], -1, n_z_los]), n_z_los, axis=1)
    n_zs_los_BIN3_prime = tf.repeat(tf.reshape(n_zs_los_BIN3, [1, -1]), theta.shape[0], axis=0)
    n_zs_los_BIN3_prime = tf.repeat(tf.reshape(n_zs_los_BIN3_prime, [theta.shape[0], -1, n_z_los]), n_z_los, axis=1)
    n_zs_los_BIN4_prime = tf.repeat(tf.reshape(n_zs_los_BIN4, [1, -1]), theta.shape[0], axis=0)
    n_zs_los_BIN4_prime = tf.repeat(tf.reshape(n_zs_los_BIN4_prime, [theta.shape[0], -1, n_z_los]), n_z_los, axis=1)
    ...
    q1 = 3./2. * H_0**2 * Omega_m0 * (1 + z_list_integ_tf) * chi * W1
    q2 = 3./2. * H_0**2 * Omega_m0 * (1 + z_list_integ_tf) * chi * W2
    q3 = 3./2. * H_0**2 * Omega_m0 * (1 + z_list_integ_tf) * chi * W3
    q4 = 3./2. * H_0**2 * Omega_m0 * (1 + z_list_integ_tf) * chi * W4
...
def correlation_compute(theta):
    ...
    xip_11 = kitching_correction_and_FT_plus_xi(theta, P_proj_11)
    xip_22 = kitching_correction_and_FT_plus_xi(theta, P_proj_22)
    xip_33 = kitching_correction_and_FT_plus_xi(theta, P_proj_33)
    xip_44 = kitching_correction_and_FT_plus_xi(theta, P_proj_44)
    xip_12 = kitching_correction_and_FT_plus_xi(theta, P_proj_12)
    xip_13 = kitching_correction_and_FT_plus_xi(theta, P_proj_13)
    xip_14 = kitching_correction_and_FT_plus_xi(theta, P_proj_14)
    xip_23 = kitching_correction_and_FT_plus_xi(theta, P_proj_23)
    xip_24 = kitching_correction_and_FT_plus_xi(theta, P_proj_24)
    xip_34 = kitching_correction_and_FT_plus_xi(theta, P_proj_34)
    
    xim_11 = kitching_correction_and_FT_minus_xi(theta, P_proj_11)
    xim_22 = kitching_correction_and_FT_minus_xi(theta, P_proj_22)
    xim_33 = kitching_correction_and_FT_minus_xi(theta, P_proj_33)
    xim_44 = kitching_correction_and_FT_minus_xi(theta, P_proj_44)
    xim_12 = kitching_correction_and_FT_minus_xi(theta, P_proj_12)
    xim_13 = kitching_correction_and_FT_minus_xi(theta, P_proj_13)
    xim_14 = kitching_correction_and_FT_minus_xi(theta, P_proj_14)
    xim_23 = kitching_correction_and_FT_minus_xi(theta, P_proj_23)
    xim_24 = kitching_correction_and_FT_minus_xi(theta, P_proj_24)
    xim_34 = kitching_correction_and_FT_minus_xi(theta, P_proj_34)
    
    iZp_U50W50_111 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_111, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_112 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_112, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_113 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_113, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_114 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_114, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_122 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_122, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_123 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_123, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_124 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_124, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_133 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_133, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_134 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_134, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_144 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_144, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_222 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_222, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_223 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_223, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_224 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_224, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_233 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_233, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_234 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_234, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_244 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_244, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_333 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_333, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_334 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_334, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_344 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_344, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZp_U50W50_444 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U50W50_proj_444, FT_plus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_111 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_111, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_112 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_112, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_113 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_113, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_114 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_114, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_122 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_122, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_123 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_123, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_124 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_124, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_133 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_133, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_134 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_134, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_144 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_144, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_222 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_222, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_223 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_223, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_224 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_224, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_233 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_233, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_234 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_234, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_244 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_244, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_333 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_333, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_334 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_334, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_344 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_344, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]
    iZm_U50W50_444 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U50W50_proj_444, FT_minus_binave_zeta_U50W50, n_angular_bins_iZ50)/A_2pt_U50W50[None,:]

    iZp_U70W70_111 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_111, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_112 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_112, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_113 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_113, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_114 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_114, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_122 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_122, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_123 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_123, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_124 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_124, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_133 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_133, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_134 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_134, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_144 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_144, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_222 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_222, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_223 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_223, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_224 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_224, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_233 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_233, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_234 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_234, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_244 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_244, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_333 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_333, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_334 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_334, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_344 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_344, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZp_U70W70_444 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U70W70_proj_444, FT_plus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_111 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_111, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_112 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_112, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_113 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_113, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_114 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_114, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_122 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_122, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_123 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_123, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_124 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_124, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_133 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_133, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_134 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_134, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_144 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_144, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_222 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_222, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_223 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_223, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_224 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_224, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_233 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_233, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_234 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_234, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_244 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_244, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_333 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_333, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_334 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_334, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_344 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_344, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    iZm_U70W70_444 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U70W70_proj_444, FT_minus_binave_zeta_U70W70, n_angular_bins_iZ70)/A_2pt_U70W70[None,:]
    
    iZp_U90W90_111 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_111, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_112 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_112, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_113 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_113, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_114 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_114, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_122 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_122, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_123 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_123, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_124 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_124, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_133 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_133, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_134 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_134, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_144 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_144, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_222 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_222, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_223 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_223, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_224 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_224, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_233 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_233, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_234 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_234, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_244 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_244, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_333 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_333, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_334 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_334, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_344 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_344, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZp_U90W90_444 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U90W90_proj_444, FT_plus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_111 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_111, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_112 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_112, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_113 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_113, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_114 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_114, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_122 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_122, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_123 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_123, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_124 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_124, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_133 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_133, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_134 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_134, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_144 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_144, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_222 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_222, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_223 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_223, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_224 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_224, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_233 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_233, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_234 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_234, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_244 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_244, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_333 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_333, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_334 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_334, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_344 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_344, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]
    iZm_U90W90_444 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U90W90_proj_444, FT_minus_binave_zeta_U90W90, n_angular_bins_iZ90)/A_2pt_U90W90[None,:]

    iZp_U110W110_111 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_111, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_112 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_112, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_113 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_113, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_114 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_114, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_122 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_122, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_123 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_123, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_124 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_124, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_133 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_133, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_134 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_134, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_144 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_144, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_222 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_222, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_223 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_223, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_224 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_224, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_233 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_233, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_234 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_234, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_244 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_244, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_333 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_333, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_334 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_334, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_344 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_344, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZp_U110W110_444 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U110W110_proj_444, FT_plus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_111 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_111, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_112 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_112, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_113 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_113, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_114 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_114, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_122 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_122, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_123 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_123, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_124 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_124, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_133 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_133, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_134 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_134, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_144 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_144, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_222 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_222, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_223 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_223, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_224 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_224, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_233 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_233, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_234 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_234, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_244 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_244, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_333 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_333, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_334 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_334, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_344 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_344, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]
    iZm_U110W110_444 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U110W110_proj_444, FT_minus_binave_zeta_U110W110, n_angular_bins_iZ110)/A_2pt_U110W110[None,:]

    iZp_U130W130_111 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_111, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_112 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_112, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_113 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_113, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_114 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_114, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_122 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_122, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_123 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_123, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_124 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_124, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_133 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_133, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_134 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_134, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_144 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_144, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_222 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_222, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_223 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_223, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_224 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_224, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_233 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_233, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_234 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_234, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_244 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_244, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_333 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_333, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_334 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_334, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_344 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_344, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZp_U130W130_444 = kitching_correction_and_FT_plus_zeta(theta, iBapp_U130W130_proj_444, FT_plus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_111 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_111, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_112 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_112, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_113 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_113, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_114 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_114, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_122 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_122, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_123 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_123, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_124 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_124, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_133 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_133, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_134 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_134, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_144 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_144, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_222 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_222, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_223 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_223, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_224 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_224, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_233 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_233, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_234 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_234, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_244 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_244, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_333 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_333, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_334 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_334, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_344 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_344, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
    iZm_U130W130_444 = kitching_correction_and_FT_minus_zeta(theta, iBamm_U130W130_proj_444, FT_minus_binave_zeta_U130W130, n_angular_bins_iZ130)/A_2pt_U130W130[None,:]
...
def log_prior(theta, theta_table):
    ...
    lnprior = tf.zeros(theta.shape[0])
...
np.save('MCMC_all_data_vector_cosmogrid_'+str(ndim)+'dim_model_1e3steps_w_nside512',samples)
#np.save('logp_zeta_plus_222_'+str(ndim)+'dim_model',logp_samples)

end = time.time()
multi_time2 = end - start2
multi_time = end - start
print("MCMC of 500 walkers and 3000 steps took {0:.1f} seconds".format(multi_time2))
